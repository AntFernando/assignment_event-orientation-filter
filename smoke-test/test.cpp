...
public:
    ...
    virtual bool setup(yarp::os::Property& property)
    {
        ...
        ROBOTTESTINGFRAMEWORK_ASSERT_ERROR_IF_FALSE(yarp::os::Network::connect("/zynqGrabber/vBottle:o", "/vOrientationFilter/vBottle:i", "udp"),
        ...
        ROBOTTESTINGFRAMEWORK_ASSERT_ERROR_IF_FALSE(yarp::os::Network::connect("/vOrientationFilter/vBottle:o", "/spikechecker/vBottle:i", "udp"),
    ...
    virtual void run()
    {
        ...
        ROBOTTESTINGFRAMEWORK_ASSERT_ERROR_IF_FALSE(outliers < 1000, "Outlier score too high (1000)");
